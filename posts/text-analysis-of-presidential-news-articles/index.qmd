...
The scientist in me immediately recognized this as an opportunity. Maybe I could quantify the media coverage of Trump and see if it differs from past presidents? This sounded like a perfect opportunity to do some text analysis and as luck would have it, I've been learning the in's and out's of David Robinson and Julia Silge's [tidytext](https://cran.r-project.org/web/packages/tidytext/index.html) package.
...
t_df <- readRDS(here::here("Data", 'trump_df.rds'))
o_df <- readRDS(here::here("Data", 'obama_df.rds'))
b_df <- readRDS(here::here("Data", 'bush_df.rds'))
j_df <- readRDS(here::here("Data", 'jinping_df.rds'))
...
bigrams <- readRDS(here::here("Data", 'news_bigrams.rds'))
```
...
Anyway, thanks for reading. A special shout-out to [David Robinson](http://varianceexplained.org/) and [Julia Silge](https://juliasilge.com/). Without their tidytext package and [text mining](https://www.tidytextmining.com/) book, this post wouldn't have been possible. I drew a lot of inspiration from their [gender and verbs](http://varianceexplained.org/r/tidytext-gender-plots/) posts when doing my bigram analysis. It's so nice to have such a great, open community to learn from!
